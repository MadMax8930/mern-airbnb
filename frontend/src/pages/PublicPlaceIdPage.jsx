...
const PublicPlaceIdPage = () => {
  ...
  return (
   <div className="bg-gray-100 mt-4 py-8 -mx-8 px-8">
      ...
      <div className="relative">
         <div className="grid grid-cols-[2fr_1fr] gap-2 rounded-3xl overflow-hidden">
            <div>
               {place.photos?.[0] && (
                  <img src={`http://localhost:4000/uploads/${place.photos[0]}`} className="aspect-square object-cover" alt="Place picture 1" />)}
            </div>
            <div>
               {place.photos?.[1] && (
                  <img src={`http://localhost:4000/uploads/${place.photos[1]}`} className="aspect-square object-cover" alt="Place picture 2" />)}
               {place.photos?.[2] && (
               <div className="overflow-hidden">
                  <img src={`http://localhost:4000/uploads/${place.photos[2]}`} className="aspect-square object-cover relative top-2" alt="Place picture 3" />
               </div>)}
            </div>
         </div>
