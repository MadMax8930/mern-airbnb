      ...
      {action === 'new' && (
         <div>
            <form action="">
               ...
               <p className="text-sm text-gray-500">More is better</p>
               ...
               <p className="text-sm text-gray-500">add check in & out times, remember to have some time window for cleaning the room between guests</p>
